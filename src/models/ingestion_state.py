...
class Entity():
    """An entity"""
    def __init__(
        self, names: list[str], translation, description, chapter_idx
    ):
        self.names = names
...
class Person(Entity):
    def __init__(self, names: list[str], translation, description, chapter_idx, age = None, gender = None):
